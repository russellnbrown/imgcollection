                        ...
                        try
                        {
                            ...
                            if ( r.img.isError() )
                            {
                                ...
                                try
                                {
                                    ...
                                    BufferedImage rz = roz.rlib.Image.Resize(bi, new Dimension(ViewSettings.tndispsize, ViewSettings.tndispsize), roz.rlib.Image.ThumbType.SCALR);
