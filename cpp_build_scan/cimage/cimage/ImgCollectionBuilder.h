...
private:
	...
	void init();							// initialize & create image processing threads
	void run(RunThreadInfo *ri);			// image processing thread method
	static void _run(RunThreadInfo *ri);	// static thread method
