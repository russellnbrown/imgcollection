...
public class ScanSet 
{
    ...
    private RTimer loadTimer = new RTimer();
    private RTimer saveTimer = new RTimer();
    private RTimer scanTimer = new RTimer();
    private RTimer intervalTimer = new RTimer();
    ...
    public static boolean Valid(Path s)
    {
    ...
    public void Load() throws ImException
    {
        try
        {
            loadTimer.reset();
            RTimer tt = new RTimer();
            tt.reset();
